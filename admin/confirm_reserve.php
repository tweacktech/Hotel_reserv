		...
		<div class = "panel panel-default">
			<div class = "panel-body">
				...
				<form method = "POST" enctype = "multipart/form-data" >
					<!-- action = "save_form.php?transaction_id=<?php echo $fetch['transaction_id']?>" -->
					<div class = "form-inline" style = "float:left;">
						<label>Firstname</label>
						<br />
						<input type = "text" value = "<?php echo $fetch['fullname']?>" class = "form-control" size = "40" disabled = "disabled"/>
					</div>
					...
					<div class = "form-inline" style = "float:left; margin-left:20px;">
						<label>Room No</label>
						<br />
						<input type = "number"  value="<?php echo $fetch['room_id']?>" min = "0" max = "999" name = "room_no" class = "form-control" required = "required"/>
					</div>
					<div class = "form-inline" style = "float:left; margin-left:20px;">
						<label>Days</label>
						<br />
						<input type = "number" min = "0" max = "99" name = "days" value="<?php echo intval($fetch['Duration']);?>"   class = "form-control" />
			...
			<?php   $as=$fetch['amounts']; require_once'save_form.php';?>
		</div>
	</div>
	<br />
	<br />
